...
url_l2m <- paste0("https://official.nba.com/",
                  "2021-22-nba-officiating-last-two-minute-reports/")
...
write_csv(corrections, paste0(local_dir, "/scraped_202122.csv"))
write_rds(corrections, paste0(local_dir, "/scraped_202122.rds"))
