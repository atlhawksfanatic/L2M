# 0-L2M-download-2020-21-splashr:
...
write_csv(corrections, paste0(local_dir, "/scraped_202021_splashr.csv"))
write_rds(corrections, paste0(local_dir, "/scraped_202021_splashr.rds"))
