...
nba_dates_long <- tribble(
  ...
  2021, "playoffs", "2021-5-18", "2021-6-30"
) %>% 
...
1. Download the raw data, these are broken up into the different years which the NBA has collected L2M:
    ...
    - [2020-21](0-data/0-L2M-download-2020-21.R) - current season and so far no PDFs. [splashr](https://github.com/hrbrmstr/splashr) package required.
