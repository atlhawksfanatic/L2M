...
nba_dates_long <- tribble(
  ...
  2022, "playoffs", "2022-4-12", "2021-6-20"
) %>% 
...
1. Download the raw data, these are broken up into the different years which the NBA has collected L2M:
    ...
    - [2021-22](0-data/0-L2M-download-2021-22.R) - current season and so far no PDFs. [splashr](https://github.com/hrbrmstr/splashr) package required.
