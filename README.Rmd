...
# Automated process
# 
# source("0-data/0-L2M-download-2019-20.R")
# 
# source("0-data/0-bkref-data.R")
# 
# source("1-tidy/1-L2M-raw.R")
# 
# source("1-tidy/1-L2M-bkref.R")
```
...
l2m %>%
  ...
  summarise(Games = n_distinct(bkref_id),
            ...
            "Correct Call Percentage" = scales::percent(sum(decision_3 == "CC") / (sum(decision_3 == "CC") + sum(decision_3 == "IC"))),
  ...
  knitr::kable(caption = paste("L2M Call Accuracy through ", max(l2m$date)), align = "c")
