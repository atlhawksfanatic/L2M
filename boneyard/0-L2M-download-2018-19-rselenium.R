# 0-L2M-download-2018-19-rselenium:
...
links_url <- paste0(links_url,
                    ifelse(grepl(pattern = "&noVideo=true$", links_url),
                           "", "&noVideo=true"))
...
write_csv(corrections, paste0(local_dir, "/scraped_201819_rselenium.csv"))
write_rds(corrections, paste0(local_dir, "/scraped_201819_rselenium.rds"))
